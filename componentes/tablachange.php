...
$conexion=conexion(); ?>
  ...
  📑 Recuerde qu este cambio solo se puede realizar a las facturas que tengan un estado "Listas para Recaudo", luego podra proceder a realizar la anulación. 👨‍🔧
		...
		<div class="card-body">
			...
			<tr>
				...
				<td>
					...
					<button class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter" Title="Cambiar Estado de la Factura" id="botonstatus" id8="<?php echo $datos ?>">  <span class="fas fa-exchange-alt"></span></button>
