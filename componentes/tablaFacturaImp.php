  ...
  <div class="card-header">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
		...
		<table class="table table-hover table-condensed table-bordered table-responsive" id="tabladinamicaload" >
		...
		<div class="card-body">
			...
			if(isset($_SESSION['consulta'])){
					...
					if($_SESSION['consulta'] > 0){
						...
						$sql="SELECT idconsumo_factura, Indentificacion	,Nombre_usuario,Apellido,Fecha,valor_total,saldo_Anteior,Estado,consumo,Lectura_anterior,Lectura_actual FROM consumo_factura JOIN registro_usuario ON consumo_factura.id_Usuario = registro_usuario.id_Usuario";

					}

				}else{

					$sql="SELECT idconsumo_factura, Indentificacion	,Nombre_usuario,Apellido,Fecha,valor_total,saldo_Anterior,Estado,consumo,Lectura_anterior,Lectura_actual FROM consumo_factura JOIN registro_usuario ON consumo_factura.id_Usuario = registro_usuario.id_Usuario";
