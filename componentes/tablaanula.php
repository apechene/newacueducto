		...
		<div class="card-body">
			...
			<tr>
				...
				<td>
					...
					<button class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter" id="botonAnula" id8="<?php echo $datos ?>">Anular <span class="fas fa-ban"></span></button>
