  ...
  <div class="card-header">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
		...
		<a role="button" class="btn btn-danger" href="facturar.php" align="center">Ir a FACTURAR</a>
			...
			if(isset($_SESSION['consulta'])){
					...
					if($_SESSION['consulta'] > 0){
						...
						$sql="SELECT idconsumo_factura, Indentificacion	,Nombre_usuario,Apellido,Fecha,valor_total,saldo_Anteior,Estado,consumo FROM consumo_factura JOIN registro_usuario ON consumo_factura.id_Usuario = registro_usuario.id_Usuario where Estado='Lista para Imprimir'";

					}

				}else{

					$sql="SELECT idconsumo_factura, Indentificacion	,Nombre_usuario,Apellido,Fecha,valor_total,saldo_Anterior,Estado,consumo FROM consumo_factura JOIN registro_usuario ON consumo_factura.id_Usuario = registro_usuario.id_Usuario where Estado='Lista para Imprimir'";
