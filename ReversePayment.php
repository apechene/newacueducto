...
<head>
	...
	<title>Reversar Pago-Acueducto San ROQUE</title>
...
<div class="table-responsive">
  ...
  <table id="example" class=" display  table-bordered table-responsive" style="width:100%">

  	<div class="card-body" align="center">
            <thead>
            <tr>
                <th>Codigo Recuado </th>
                <th>Codigo Factura recaudada</th>
                <th>Valor Recaudado</th>
                <th>Tipo de Recaudo</th>
                <th>Fecha del Recaudo</th>
...
<script>
        ...
        $(document).on('click', '#getEdits', function(){
...
<script>
  $(document).on("click", "#getEdit", function(){
    ...
    var id13= $(this).data("idconsumo_factura");
