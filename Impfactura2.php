    ...
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item dropdown">
       ...
       <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">          <a class="dropdown-item" href="facturar.php">Facturar</a>          <a class="dropdown-item" href="factura.php">ver Facturas</a>		  <a class="dropdown-item" href="ImpFacturaLI.php">Facturas Listas para Impresión</a>		  <a class="dropdown-item" href="ImpFacturaL.php">Facturas Listas para Recaudo</a>          <a class="dropdown-item" href="Impfactura.php">Imprimir Facturas</a>        </div>
      </li>
	  <li class="nav-item">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">FACTURAS EMITIDAS</h5>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#tabla').load('componentes/tablaFacturaImp.php');
...
var id15= $(this).attr("id8");

    $.ajax({
        url:"componentes/factura.php",
        method:"post",
        data:{id15:id15},
