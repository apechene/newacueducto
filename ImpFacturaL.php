...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#tabla').load('componentes/tablaFacturaImpL.php');
...
var id15= $(this).attr("id8");
    ...
    $.ajax({
        ...
        success:function(data){
          ...
          var newWindow = window.open("http://acuesanroque.xyz/Acueductonew/ImpFacturaL.php", "new window", "width=900, height=600");
