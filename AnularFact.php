...
<head>
  ...
  <title>JUNTA ADMISNITRADORA ACUDUCTO SAN ROQUE-MORALES C. Anular Factura </title>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="exampleModalCenterTitle">Anular Facturas</h5>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#tabla').load('componentes/tablaanula.php');
...
<script>
  $(document).on("click", "#botonAnula", function(){

var id99= $(this).attr("id8");
